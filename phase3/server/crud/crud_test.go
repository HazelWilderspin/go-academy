...
var (
	username = "ALPHA"
	userId   = uuid.Must(uuid.Parse("5ad98d52-5c4e-412e-a6ad-d33598f22c9e"))
	listId   = uuid.Must(uuid.Parse("17f0603d-a086-41f3-b42c-d4021f900431"))
	itemId   = uuid.Must(uuid.Parse("4bd26263-efbb-49d6-92f7-48fc0de092fe"))
)
